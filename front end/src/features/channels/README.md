# channels frontend ownership

| Feature | Route | Component |
|---|---|---|
| Instagram inbox | `/instagram` | `src/features/channels/InstagramPage.jsx` |
| Telegram inbox | `/telegram` | `src/features/channels/TelegramPage.jsx` |
| SMS inbox | `/sms` | `src/features/channels/SmsPage.jsx` |
| Email inbox | `/email` | `src/features/channels/EmailPage.jsx` |
