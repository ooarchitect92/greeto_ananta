# settings frontend ownership

| Feature | Route | Component |
|---|---|---|
| Connected integrations | `/integrations` | `src/features/settings/SettingsPage.jsx` |
| Workspace settings | `/settings` | `src/features/settings/SettingsPage.jsx` |
| My profile | `/profile` | `src/features/settings/ProfilePage.jsx` |
